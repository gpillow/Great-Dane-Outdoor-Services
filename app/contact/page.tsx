...
export default function ContactPage() {
  return (
    <main id="main-content" style={{ backgroundColor: '#303030', color: '#f0f0f0', fontFamily: 'sans-serif' }}>
      ...
      {/* MAIN CONTENT */}
      <section className="section-shaped section-band" style={{ padding: '80px 20px', background: '#3a3a3a' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'start' }}>
          ...
          <div className="quote-panel">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '3rem' }}>
              <div className="ui-card" style={{ background: '#464646', border: '1px solid #565656', borderRadius: '12px', padding: '1.5rem' }}>
