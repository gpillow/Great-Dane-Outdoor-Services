    ...
    <main style={{ backgroundColor: '#0a0a0a', color: '#d0d0d0', fontFamily: 'sans-serif' }}>
      ...
      <section style={{ padding: '120px 20px 80px', textAlign: 'center', background: 'linear-gradient(180deg, #0a0a0a 0%, #0f1a0f 100%)', borderBottom: '1px solid #1e2e1e' }}>
        <ScrollReveal>
          ...
          <p style={{ color: '#888', maxWidth: '580px', margin: '0 auto', fontSize: '1.1rem', lineHeight: 1.8 }}>
      ...
      <section style={{ padding: '100px 20px', background: '#0d0d0d' }}>
        <div style={{ maxWidth: '760px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '3rem' }}>
          <ScrollReveal direction="left">
            <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '12px', padding: '2.5rem' }}>
              <h2 style={{ color: '#C0C0C0', fontSize: '1.4rem', fontWeight: 700, marginBottom: '1rem' }}>Where It Started</h2>
          ...
          <ScrollReveal direction="right">
            <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '12px', padding: '2.5rem' }}>
              <h2 style={{ color: '#C0C0C0', fontSize: '1.4rem', fontWeight: 700, marginBottom: '1rem' }}>What We Stand For</h2>
              <p style={{ color: '#888', lineHeight: 1.8, fontSize: '1rem' }}>
          ...
          <ScrollReveal direction="left">
            <div style={{ background: '#1a1a1a', border: '1px solid #2a2a2a', borderRadius: '12px', padding: '2.5rem' }}>
              <h2 style={{ color: '#C0C0C0', fontSize: '1.4rem', fontWeight: 700, marginBottom: '1rem' }}>Why Northwest Arkansas</h2>
              <p style={{ color: '#888', lineHeight: 1.8, fontSize: '1rem' }}>
      ...
      {/* STATS / FACTS */}
      <ScrollReveal>
        <section style={{ padding: '80px 20px', background: '#111', borderTop: '1px solid #1e2e1e', borderBottom: '1px solid #1e2e1e' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '3rem', maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
            {[
              ...
              <div key={item.stat}>
                ...
                <p style={{ color: '#666', fontSize: '0.85rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase' }}>{item.label}</p>
              </div>
            ))}
          </div>
        </section>
      ...
      <ScrollReveal>
        <section style={{ padding: '100px 20px', textAlign: 'center', background: 'linear-gradient(180deg, #0f1a0f 0%, #0a0a0a 100%)', borderTop: '1px solid #1e2e1e' }}>
          ...
          <p style={{ color: '#888', marginBottom: '2.5rem', fontSize: '1.1rem' }}>Reach out for a free quote — no pressure, no obligation.</p>
