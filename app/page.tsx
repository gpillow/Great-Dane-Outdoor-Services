...
export default function HomePage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/hero-v3-mobile.webp" fetchPriority="high" type="image/webp" media="(max-width: 640px)" />
      <link rel="preload" as="image" href="/hero-v3.webp" fetchPriority="high" type="image/webp" media="(min-width: 641px)" />
