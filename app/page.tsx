...
export default function HomePage() {
  return (
    <>
      ...
      <link rel="preload" as="image" href="/hero-main-mobile.webp" fetchPriority="high" type="image/webp" media="(max-width: 640px)" />
      <link rel="preload" as="image" href="/hero-main.webp" fetchPriority="high" type="image/webp" media="(min-width: 641px)" />
