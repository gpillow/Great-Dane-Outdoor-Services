    ...
    <main id="main-content" className="pricing-page">
      ...
      <section className="pricing-area">
        <div className="pricing-shell">
          <h2>Service Area</h2>
          <p>
            Great Dane Outdoor Services provides pressure washing, brush removal, junk removal, landscaping refreshes, leaf cleanups, and seasonal outdoor work across Northwest Arkansas, including Fayetteville, Rogers, Bentonville, Springdale, Farmington, Lowell, Centerton, Bella Vista, Cave Springs, Siloam Springs, Elkins, and Prairie Grove.
          </p>
